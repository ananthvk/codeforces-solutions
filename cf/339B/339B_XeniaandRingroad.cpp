...
int main()
{
    ...
    // prev_house:= 1
    // time_taken:= 0
    // m:= array of input tasks
    // for i = 0 to m_-1
    //     if prev_house <= m[i]
    //         time_taken += m[i] - prev_house
    //     else
    //         time_taken += (n - prev_house + 1) + (m[i] - 1)
    //         [To go to the first position and then move to the required]
    //     prev_house = m[i]
