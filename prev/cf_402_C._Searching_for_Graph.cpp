...
{
    FAST_IO
    // This looks like a greedy problem to me
    // Choose the first vertex in the set of vertices
    // Make sure that it contains 2(1) + p or 2 + p edges, by choosing 2 + p vertices from the remaining vertices
    // Choose the second vertex, make sure that it also has 2(1) + 1 or 2 + p connections
    return 0;
}
